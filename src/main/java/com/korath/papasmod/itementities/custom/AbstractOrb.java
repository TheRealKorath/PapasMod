...
public abstract class AbstractOrb extends Projectile {
    private static final double ARROW_BASE_DAMAGE = 2.0D;
    private static final EntityDataAccessor<Byte> ID_FLAGS = SynchedEntityData.defineId(AbstractOrb.class, EntityDataSerializers.BYTE);
    private static final EntityDataAccessor<Byte> PIERCE_LEVEL = SynchedEntityData.defineId(AbstractOrb.class, EntityDataSerializers.BYTE);
    ...
    public AbstractOrb.Pickup pickup = AbstractOrb.Pickup.DISALLOWED;
    ...
    protected AbstractOrb(EntityType<? extends AbstractOrb> p_36721_, Level p_36722_) {
        super(p_36721_, p_36722_);
    }

    protected AbstractOrb(EntityType<? extends AbstractOrb> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
        this(p_36711_, p_36715_);
        this.setPos(p_36712_, p_36713_, p_36714_);
    }

    protected AbstractOrb(EntityType<? extends AbstractOrb> p_36717_, LivingEntity p_36718_, Level p_36719_) {
        ...
        if (p_36718_ instanceof Player) {
            this.pickup = AbstractOrb.Pickup.ALLOWED;
        }
    ...
    public void readAdditionalSaveData(CompoundTag p_36761_) {
        ...
        this.pickup = AbstractOrb.Pickup.byOrdinal(p_36761_.getByte("pickup"));
    ...
    public void setOwner(@Nullable Entity p_36770_) {
        ...
        if (p_36770_ instanceof Player) {
            this.pickup = ((Player)p_36770_).getAbilities().instabuild ? AbstractOrb.Pickup.CREATIVE_ONLY : AbstractOrb.Pickup.ALLOWED;
        }
    ...
    public static enum Pickup {
        ...
        public static AbstractOrb.Pickup byOrdinal(int p_36809_) {
